...
def parse_args():
    ...
    parser.add_argument('--original_dataset_path',
                        type=str,
                        default="",
                        help="First Dataset path")
    parser.add_argument('--ddpm_dataset_path',
                        type=str,
                        default="",
                        help="Second Dataset path")
    parser.add_argument('--original_batch_size',
                        type=int,
                        default=0,
                        help="First Dataset batch size")
    parser.add_argument('--ddpm_batch_size',
                        type=int,
                        default=0,
                        help="Second Dataset batch size")
